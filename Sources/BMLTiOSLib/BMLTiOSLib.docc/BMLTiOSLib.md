...
This is an SDK, allowing iOS and MacOS apps to access and control a BMLT Root Server.

## Overview

The BMLTiOSLib fits between [the BMLT Root Server's Semantic Interface](https://bmlt.app/semantic/) and your iOS app:

![Chart, Showing Where the BMLTiOSLib Fits](BMLTiOSLibSetup.png)
...
![Interaction Diagram](InitialConnection.png)
