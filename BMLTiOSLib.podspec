...
Pod::Spec.new do |s|
    ...
    s.description               = 'The BMLTiOSLib is a Swift shared framework designed to allow easy development of iOS BMLT apps. It completely abstracts the connection to BMLT Root Servers, including administration functions.'
    s.homepage                  = 'https://bmlt.magshare.net/BMLTiOSLib'
    s.documentation_url         = 'https://bmlt.magshare.net/bmlt-doc/'
